export default {
  global: {
    Name: 'Comprensión lectora mediante análisis crítico',
    Description:
      'El componente formativo integra técnicas para comprender textos mediante análisis crítico, así como estrategias de lectura activa. Aborda la identificación de ideas principales, evaluación de argumentos y construcción de opiniones fundamentadas; asimismo, desarrolla habilidades reflexivas. De esta manera, se fortalecen competencias para interpretar textos en diversos contextos.',
  ...
  menuPrincipal: {
    ...
    subMenu: [
      ...
      },
      {
        ...
        download: 'downloads/CFA02_52130001__DU.pdf',
      },
      {
