...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .titulo-tres.mt-5: h3 Elementos que conforman un texto

    p Un texto es un todo; ese todo está compuesto por elementos más pequeños, que en su orden descendente son:
    ...
    .row.mt-4
      ...
      .col-lg-9
        p El texto puede tener apartados, capítulos o subtemas. Cada apartado está compuesto de párrafos. Cada párrafo está formado por oraciones. Cada oración está compuesta de palabras. Incluso cada palabra está conformada por partes.

        p Algunas de esas partes que forman la palabra contienen el significado principal y otras partes, como los sufijos y prefijos, poseen los significados complementarios.
        ...
        .row
          .col-lg-6.mb-4.mb-lg-0
            .tarjeta.bg-2.p-4.p-md-5.h-100.text-center
              ...
              p.mb-4 Es la base fundamental para comprender cualquier texto.

              h5.mb-3 ¿Qué puedo hacer cuando me encuentro con palabras desconocidas?
              p.mb-0 Puedes recurrir a diferentes estrategias que te permitan aproximarte a su significado sin necesidad de interrumpir la lectura para consultar un diccionario.
          ...
          .col-lg-6
            .tarjeta.bg-8.p-4.p-md-5.h-100.text-center
              ...
              p.mb-4 La unidad de sentido más pequeña y completa para comunicar ideas.

              h5.mb-3 ¿Qué se expresa mediante las oraciones?
              p.mb-0 Hechos, deseos, opiniones, dudas, preguntas, órdenes, suposiciones, sorpresas y asombros.


    p.mt-4 Identificar la intencionalidad de una oración es clave para comprender su significado. Para ello, se pueden aplicar las siguientes estrategias:
